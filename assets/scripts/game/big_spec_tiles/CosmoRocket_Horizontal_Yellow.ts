...
@ccclass('CosmoRocket_Horizontal_Yellow')
export class CosmoRocket_Horizontal_Yellow extends CosmoRocket_Horizontal {
    ...
    subscribeOnFieldEvents(field: Node) {
        ...
        let curGoal = goals.find((goal) => goal.id === "yellow");
